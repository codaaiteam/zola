...
export const MODEL_CREDIT_RATES: { pattern: string; rate: number; label: string }[] = [
  ...
  { pattern: "gpt-4o-mini", rate: 1, label: "GPT-4o Mini" },
  ...
  { pattern: "gpt-4o\"", rate: 9, label: "GPT-4o" },
  { pattern: "gpt-5.4\"", rate: 13, label: "GPT-5.4" },
  { pattern: "gpt-5.5-pro", rate: 150, label: "GPT-5.5 Pro" },
...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    monthlyPrice: 0,
    yearlyPrice: 0,
    description: "Try budget models",
    features: [
      "Budget models only (Nano, DeepSeek, Llama)",
      "100 credits / month",
      "Basic chat",
    ],
    credits: 100,
  ...
  },
  {
    ...
    monthlyPrice: 19.9,
    yearlyPrice: 199,
    description: "Unlock all models",
    features: [
      "All models (Claude, GPT-5.4, Gemini Pro)",
